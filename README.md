# Site Institucional e Blog para Canarinho Mudanças
...
* **Template de Página Customizado:** Criação de um modelo de página de aterrissagem genérico em PHP para futuras campanhas.
* **Blog com Layout Dinâmico:** Implementação de um layout "zigue-zague" para os artigos do blog usando HTML semântico e CSS Flexbox, garantindo responsividade.
* **Formulário de Orçamento Avançado:**
    * Implementação e validação de campos obrigatórios.
    * Resolução de problemas de recebimento de dados (tags de e-mail).
    * Melhoria da experiência do usuário com placeholders e sugestão de máscara de input.
    * Criação de campos condicionais e de múltipla escolha para detalhamento do orçamento.
* **Notificações por E-mail em HTML:** Transformação das notificações de e-mail padrão em um template HTML profissional e de fácil leitura para o cliente.
...
Este projeto foi uma excelente oportunidade para aprofundar minhas habilidades em desenvolvimento de temas para WordPress e na resolução de problemas do mundo real. O maior desafio foi diagnosticar a falha de validação de e-mail no Contact Form 7, o que me levou a estudar o funcionamento interno do plugin e a desenvolver uma solução robusta com um filtro PHP customizado. Além disso, a tarefa de criar um e-mail HTML compatível com diversos clientes de e-mail reforçou a importância de pensar na experiência do usuário em todas as etapas do projeto.
